...
//builder.Services.AddDbContext<CenterContext>(options => options.UseSqlServer("workstation id=ElManhag.mssql.somee.com;packet size=4096;user id=Hamzawy9678_SQLLogin_1;pwd=84xajz434s;data source=ElManhag.mssql.somee.com;persist security info=False;initial catalog=ElManhag"));
