...
namespace Courses_Center.Controllers
{
    ...
    public class SourceController : Controller
    {
        ...
        public IActionResult Details(SourceDisplayDTO sourceDisplayDTO)
        {
            ...
            ListSourceDto listSourceDto = new ListSourceDto();
            listSourceDto.Sources = source;
            listSourceDto.SourceDisplay=sourceDisplayDTO;

            return PartialView("SourceDisplay", listSourceDto);
        ...
        public IActionResult Update(int Id, int department, int colleges, int unversity)
        {
            ...
            var crsProf = _courseProfessorService.GetAll().Where(P => P.CrsId == source.CrsID).ToList();
            var allprof = _profService.GetAll().Where(P => P.Id == crsProf[0].ProfId);
